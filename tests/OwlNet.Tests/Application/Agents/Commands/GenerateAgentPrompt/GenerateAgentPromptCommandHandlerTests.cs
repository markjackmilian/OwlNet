...
namespace OwlNet.Tests.Application.Agents.Commands.GenerateAgentPrompt;

/// <summary>
/// Unit tests for <see cref="GenerateAgentPromptCommandHandler"/>.
...
/// </summary>
public sealed class GenerateAgentPromptCommandHandlerTests
{
    private const string DefaultAgentType = "primary";
    private const string DefaultAgentName = "owl-coder";
    private const string DefaultAgentDescription = "A coding assistant agent";

    private readonly ILlmChatService _llmChatService;
    private readonly GenerateAgentPromptCommandHandler _sut;

    public GenerateAgentPromptCommandHandlerTests()
    {
        _llmChatService = Substitute.For<ILlmChatService>();
        _sut = new GenerateAgentPromptCommandHandler(
            _llmChatService,
            NullLogger<GenerateAgentPromptCommandHandler>.Instance);
    }
    ...
    public async Task Handle_ForceGenerateWithHistory_AddsForceMessageAtEnd()
    {
        ...
        {
            new("assistant", "What framework do you use?"),
            new("user", "ASP.NET Core")
        };
    ...
    public async Task Handle_WithConversationHistory_IncludesHistoryInMessages()
    {
        ...
        capturedMessages[2].ShouldSatisfyAllConditions(
            ...
            () => capturedMessages[2].Content.ShouldBe("Code review")
        );
        ...
        capturedMessages[4].ShouldSatisfyAllConditions(
            ...
            () => capturedMessages[4].Content.ShouldBe("C# and TypeScript")
        );
    }
    ...
    public async Task Handle_ValidRequest_InitialMessageContainsAgentDetails()
    {
        ...
        initialMessage.ShouldSatisfyAllConditions(
            () => initialMessage.ShouldContain("subagent"),
            () => initialMessage.ShouldContain("owl-reviewer"),
            () => initialMessage.ShouldContain("Reviews pull requests")
        );
    }
    ...
    public async Task Handle_NoForceGenerateWithHistory_DoesNotAppendForceMessage()
    {
        ...
        capturedMessages[^1].ShouldSatisfyAllConditions(
            ...
            () => capturedMessages[^1].Content.ShouldBe("Blazor")
        );
    }
    ...
    private static GenerateAgentPromptCommand CreateCommand(
