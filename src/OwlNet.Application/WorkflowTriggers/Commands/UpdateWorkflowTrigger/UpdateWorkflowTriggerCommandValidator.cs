...
/// <summary>
/// FluentValidation validator for <see cref="UpdateWorkflowTriggerCommand"/>.
/// Enforces all field constraints and cross-field rules before the handler executes.
/// </summary>
public sealed class UpdateWorkflowTriggerCommandValidator
    : AbstractValidator<UpdateWorkflowTriggerCommand>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="UpdateWorkflowTriggerCommandValidator"/> class.
    /// </summary>
    public UpdateWorkflowTriggerCommandValidator()
    {
